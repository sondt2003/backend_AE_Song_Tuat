...
const orderSchema = new Schema({
    ...
    order_checkout: {type: Object, default: {}}, /* order_checkout={
            totalPrice,
            totalApplyDiscount,
            feeShip,
        }*/
    order_shipping: {type: Object, default: {}}, /* order_shipping={
            street,
            city,
            state,
            country,
    ...
    order_status: {
        ...
        default: "pending",
    }, //pending dơn hàng đang chờ  đã được tạo nhưng chưa được ử lý
    ...
    collection: COLLECTION_NAME, timestamps: {
        createdAt: "createdOn", updatedAt: "modifiedOn",
    },
});
